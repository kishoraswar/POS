...
#==========image=============
        ...
        lbl_image=Label(self.root,bd=0,image=self.BillPhoto)
...
#=========================
    def show(self):  
        ...
        #print(os.listdir('../pos')) bill1.txt,category.py
    ...
    def get_Data(self,ev):  #ev-event
        index_=self.Sales_List.curselection()
        file_name=self.Sales_List.get(index_)
        print(file_name)
        self.bill_area.delete('1.0',END) #clearing bill area
...
#==============search invoice
    def search(self):
        if self.var_invoice.get()=="":
            ...
            #print(self.bill_list,self.var_invoice)
